    ...
    <div>
      <section id="section-1" className="sec-1 ">
        ...
        <p className="text-body animate">
          ...
          kwiaty, otwierają się tylko wtedy, kiedy nadchodzi właściwy czas
          jeżeli chcesz rozkwitnąć i zmienić coś w swoim życiu zapraszam do
          szkoły policealnej Dorota Oniśko Flower Artis już dziś 🌺
        </p>
      </section>
      <section id="section-2" className="sec-2">
        <p className="text-body animate">
          ...
          Absolwenci otrzymują świadectwo ukończenia szkoły, które jest
          równoważne z uzyskaniem certyfikatu B1 z języka polskiego. Zapisujemy
          uczniów na pierwszy i drugi semestr, przede wszystkim jednak
          gwarantujemy wspaniałą atmosferę i pełne zaangażowanie ze strony
